...
?>
    <?php echo bf_alert('Custom languages in full version, only', 'http://crosstec.de/en/extensions/joomla-forms-download.html');?>

    <div class="bfLanguageButton<?php echo $active_language_code == JFactory::getLanguage()->getDefault() || $active_language_code == '' ? ' bfLanguageButtonActive' : '' ?>"><?php echo JFactory::getLanguage()->getDefault(); ?></div> 
    <?php
    $languages = JLanguageHelper::getLanguages();
    foreach($languages As $language){
        if($language->lang_code != JFactory::getLanguage()->getDefault()){
    ?>
    <div class="bfLanguageButton<?php echo $active_language_code == $language->lang_code ? ' bfLanguageButtonActive' : '' ?>"><?php echo $language->lang_code; ?></div> 
            <?php
        }
    }
		            	...
		            	<div class="bfAdvanced" id="bfFormAdvanced" style="display:none">
			            	...
			            	<fieldset>
		            			...
		            			<input onclick="JQuery('#bfThemeBootstrapDiv').css('display','none');JQuery('#bfThemeBreezingFormsDiv').css('display','block');" <?php echo (version_compare($version->getShortVersion(), '3.0', '<') ? 'checked="checked" ' : ''); ?>type="radio" name="bfThemeBootstrapThemeEngine" value="" id="bfThemeBootstrapThemeBreezingForms"/> BreezingForms
                                                ...
                                                <?php echo bf_alert('Bootstrap based themes available in full version only.', 'http://crosstec.de/en/extensions/joomla-forms-download.html');?>
                                                <?php echo bf_alert('Please use BreezingForms based themes or get the full version.', 'http://crosstec.de/en/extensions/joomla-forms-download.html');?>
...
>			            		<?php
						...
						$dbObject = Zend_Json::decode($dataObjectString);
			            		...
			            		<?php echo bf_alert('Mobile Forms available in full version only', 'http://crosstec.de/en/extensions/joomla-forms-download.html');?>
			            ...
			            <div class="bfAdvanced" id="bfElementAdvanced" style="display:none">
			            	...
			            	<fieldset>
			            		...
			            		<div class="bfElementTypeClass" id="bfElementTypeFileAdvanced" style="display:none">
                                                        <?php echo bf_alert('HTML5 Upload in full version only', 'http://crosstec.de/en/extensions/joomla-forms-download.html');?>
                                                        <br/><br/>
                                                        <div class="bfPropertyWrap">
