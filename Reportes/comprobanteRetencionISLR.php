...
require "../php/egresos_administrativos.php";
	...
	if (isset($_GET['egre'])) {
$items = cargarRetencionesISLR(base64_decode($_GET['pag']), base64_decode($_GET['pag']));	
} else {
$items = cargarRetencionesISLR(base64_decode($_GET['pag']));
...
$total = $total + ($value['islr_retenido']);
}
$total = number_format($total, 2, '.', ',');

} else {
	$cuerpo = "<tr><td style=\"text-align:center;\" colspan=\"8\">No hay Facturas</td></tr>";
$rif_proveedor = "";
$proveedor = "";
$fecha_retencion = "";
$año = "";
...
<h3 style="text-align:center;">Comprobante de Retención<br>Impuesto Sobre la Renta</h3>
...
<table border="0" style="font-size:10px; text-align:center;">
	<thead>
		<tr  style="text-align:center; font-weight: bold;">
			...
			<th style="border: 1px solid black;" rowspan="2">Codigo Concepto</th>
			<th style="border: 1px solid black;" rowspan="2">Base Imponible</th>
			<th style="border: 1px solid black;" rowspan="2">Porcentaje Rent. Aplicado</th>
			<th style="border: 1px solid black;" rowspan="2">I.S.L.R. Retenido</th>
		</tr>
		<tr  style="text-align:center; font-weight: bold;">
...
<tr><td colspan="7" style="text-align:right;"><b>Total Retenido: </b></td><td>$total</td></tr>
