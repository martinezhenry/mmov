				...
				if(trim($form->template_code_processed) == ''){
					echo "</div>\n";
                                ...
                                if(JFile::exists(JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'BFISNEW')){
                                    echo '<div style="clear:both; display: block; text-align: center; margin-top: 20px;"><a style="margin: 0 auto;" href="javascript:alert(\'This is the Lite version of BreezingForms. Please visit crosstec.de to get a footer removal and more features.\');" rel="nofollow">Made with BreezingForms for Joomla!&reg; by Crosstec</a></div>';
                                }
