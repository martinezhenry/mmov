...
// script2clause
    ...
    function loadBuiltins(&$library) {
        ...
        $code = "function ff_submitForm()" . nl() .
                "{if(document.getElementById('bfSubmitButton')){document.getElementById('bfSubmitButton').disabled = true;} bfCheckCaptcha();}" . nl();
        $code.= "function ff_submitForm2()" . nl() .
                "{if(document.getElementById('bfSubmitButton')){document.getElementById('bfSubmitButton').disabled = true;}" . nl();
        if ($this->inline)
...
// expxml
    ...
    function sendEmailNotification() {
        ...
        //if($isHtml){
        //    $body = '<a href="http://crosstec.de/en/extensions/joomla-forms-download.html">Get BreezingForms Full Version! More features, no footers, no messages!</a><br/><br/>'.$body;
        //}else{
        //    $body = 'Get BreezingForms Full Version! More features, no footers, no messages:'."\n".'http://crosstec.de/en/extensions/joomla-forms-download.html'."\n\n".$body;
        //}
...
// sendEmailNotification
    ...
    function saveUpload($filename, $userfile_name, $destpath, $timestamp, $useUrl = false, $useUrlDownloadDirectory = '',$resize_target_width=0,$resize_target_height=0,$resize_type='',$resize_bgcolor='#ffffff') {
        ...
        if($fmtest != basename($_baseDir)){
            ...
            $fm = str_replace('{filemask:_datetime}', trim(date('YmdHis')), $fm);
